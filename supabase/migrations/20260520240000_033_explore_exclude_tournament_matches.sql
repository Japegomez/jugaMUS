-- 033: Exclude tournament bracket matches from public explore; block manual join/leave.
...
DROP POLICY IF EXISTS participants_update_self ON public.match_participants;
